  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setFormData({ name: '', phone: '', email: '', service: '', message: '', projectType: '', budget: '' });
        setTimeout(() => { onClose(); setSubmitStatus('idle'); }, 3000);
      } else {
        throw new Error(data.error || 'Something went wrong.');
      }
    } catch (err) {
      setSubmitStatus('error');
      setErrorMessage(err.message || 'Something went wrong. Please try again or call +91-9718401731');
    } finally {
  ...
  return (
    <>
          ...
          {submitStatus === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="popup-form">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label htmlFor="phone"><i className="fas fa-phone-alt"></i> Phone Number *</label>
                  <input type="tel" id="phone" name="phone" value={formData.phone}
                    onChange={handleChange} required placeholder="Enter your phone number" />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input type="email" id="email" name="email" value={formData.email}
                    onChange={handleChange} required placeholder="Enter your email address" />
                </div>
                <div className="form-group">
                  <label htmlFor="service"><i className="fas fa-code"></i> Service Interested In *</label>
              ...
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="projectType"><i className="fas fa-project-diagram"></i> Project Type</label>
                ...
                <div className="form-group">
                  <label htmlFor="budget"><i className="fas fa-rupee-sign"></i> Estimated Budget</label>
              ...
              <div className="form-group full-width">
                <label htmlFor="message"><i className="fas fa-comment"></i> Project Details / Message *</label>
      ...
      <style jsx>{`
        ...
        .popup-container::-webkit-scrollbar-track { background: rgba(255,255,255,0.1); border-radius: 10px; }
        .popup-container::-webkit-scrollbar-thumb { background: #00c49a; border-radius: 10px; }
        ...
        .popup-close:hover { background: #ff4757; transform: rotate(90deg); }
        ...
        .popup-header h2 { color: white; font-size: 28px; margin-bottom: 10px; }
        .popup-header p  { color: rgba(255,255,255,0.7); font-size: 14px; }
        ...
        .form-group label i { color: #00c49a; font-size: 14px; }
        ...
        .form-note i { color: #00c49a; }

        .success-message { text-align: center; padding: 50px 30px; }
        .success-message i { font-size: 70px; color: #00c49a; margin-bottom: 20px; }
        .success-message h3 { color: white; font-size: 24px; margin-bottom: 10px; }
        .success-message p  { color: rgba(255,255,255,0.7); margin-bottom: 30px; }
        .close-success-btn {
          background: linear-gradient(135deg, #00c49a, #00a37a);
        ...
        @media (max-width: 768px) {
          ...
          .popup-container { width: 95%; margin: 20px; }
